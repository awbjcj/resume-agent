      ...
      >
        ...
        <div className="relative mt-auto max-w-xl rounded-2xl border border-white/12 bg-[#061d26]/58 p-6 shadow-[0_24px_80px_-32px_rgba(0,0,0,0.72)] backdrop-blur-xl xl:p-7">
          <p className="text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-cyan-200/75">
            Evidence-led career operations
          </p>
          ...
          <div className="mt-6 flex items-center gap-2 text-[0.7rem] font-medium text-white/72">
            <span className="rounded-full border border-white/12 bg-white/7 px-3 py-1.5">Discover</span>
            <span className="h-px w-5 bg-white/18" />
            <span className="rounded-full border border-white/12 bg-white/7 px-3 py-1.5">Tailor</span>
            <span className="h-px w-5 bg-white/18" />
            <span className="rounded-full border border-white/12 bg-white/7 px-3 py-1.5">Track</span>
          </div>
        </div>
      </aside>
      <main className="auth-surface flex min-h-svh w-full items-center justify-center px-4 py-6 sm:px-8 sm:py-10 lg:w-[46%] 2xl:w-[43%]">
