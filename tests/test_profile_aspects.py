...
def test_bullet_aspect_is_optional_but_closed():
    ...
    assert Bullet(text="Led the incident review", aspect="leadership").aspect == "leadership"
...
def test_all_extraction_prompts_require_a_closed_bullet_aspect():
    ...
    from resume_agent.profile.project_extractor import _INSTRUCTIONS as project_instructions
