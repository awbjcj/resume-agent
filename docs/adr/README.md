...
| [0009](0009-registration-modes-platform-budget-governance.md) | Registration modes + platform budget governance | Account creation and shared-LLM-key eligibility are separate decisions; a global daily signup cap and weekly token budget bound worst-case spend regardless of account count. |
