...
from resume_tailor_harness.tailor.review_config import LengthBudget as DomainLengthBudget
from resume_tailor_harness.tailor.review_config import ReviewConfig as DomainReviewConfig
