...
from resume_tailor_harness.taxonomy.countries import COUNTRY_TO_ISO2 as _COUNTRY_TO_ISO2
from resume_tailor_harness.taxonomy.countries import ISO2_CODES as _ISO2_CODES
