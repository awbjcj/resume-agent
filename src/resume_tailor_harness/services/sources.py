...
from resume_tailor_harness.discovery.source_resolution.catalog import canonical_target_url
...
from resume_tailor_harness.security.outbound import resolve_host as _resolve_host
from resume_tailor_harness.services.discovery import DEFAULT_CONNECTORS, DEFAULT_SEARCH
