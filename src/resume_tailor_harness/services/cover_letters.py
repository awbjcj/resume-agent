...
from resume_tailor_harness.career_skills.models import CoverLetterSkillName
...
from resume_tailor_harness.tenancy.paths import FACTS_PATH as DEFAULT_FACTS
