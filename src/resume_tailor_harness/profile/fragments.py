...
from resume_tailor_harness.profile.extractor import PROMPT_VERSION, aextract_profile_facts
...
from resume_tailor_harness.profile.resume_reader import CONVERTER_VERSION, read_document_text
