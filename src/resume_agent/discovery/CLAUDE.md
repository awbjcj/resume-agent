...
Migrated from the project root `CLAUDE.md` (2026-08-15, CLAUDE.md split) — loads only when working under `src/resume_agent/discovery/`.
...
> ATS/job-board connector internals (detection, ATS readers, companies dispatch, Workday pagination, Tesla/Google portals, pooled HTTP, relevance gates) live in `src/resume_agent/discovery/connectors/CLAUDE.md`.
