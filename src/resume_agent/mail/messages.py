...
def verification_code(code: str) -> Message:
    return Message(
        "Your Resume Agent verification code",
...
def reset_code(code: str) -> Message:
    return Message(
        "Your Resume Agent password reset code",
...
def password_changed(base_url: str) -> Message:
    return Message(
        "Your Resume Agent password was changed",
...
def google_linked(base_url: str) -> Message:
    return Message(
        "A Google account was linked to your Resume Agent account",
...
def google_unlinked(base_url: str) -> Message:
    return Message(
        "Google sign-in was removed from your Resume Agent account",
