...
> ATS/job-board connector internals (detection, ATS readers, companies dispatch, Workday pagination, relevance gates) live in `src/resume_agent/discovery/connectors/CLAUDE.md`.
